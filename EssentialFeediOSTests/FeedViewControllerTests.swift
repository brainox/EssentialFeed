...
//
//  Created by Obinna on 23/05/2024.
//
...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_loadingFeedIndicator_isVisibleWhileLoadingFeed() {
        ...
        sut.beginAppearanceTransition(true, animated: false)
        sut.endAppearanceTransition()
        XCTAssertTrue(sut.isShowingLoadingIndicator, "Expected loading indicator once view is completed")
    ...
    func test_feedImageView_renderImageLoadedFromURL() {
        ...
        XCTAssertEqual(view1?.renderedImage, imageData1, "Expected image for second view once secong image loading completes successfully")
    }
